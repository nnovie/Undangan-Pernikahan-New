...
.bgimg {background-image: url("file:///C:/Users/DELL/Pictures/65585d2fbe991b5.jpg")}
.bgimg2 {background-image: url("file:///C:/Users/DELL/Downloads/download.jpg")}
</style>
</head>
<body>
...
<header class="w3-display-container w3-wide bgimg w3-grayscale-min" id="home">
  <div class="w3-display-middle w3-text-black w3-center">
    <h1 class="w3-jumbo">Wiwi Sartika & Boy Alexander Marita</h1>
    <h2>Are getting married</h2>
    <h2><b>28-08-2004</b></h2>
  </div>
</header>
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    ...
    <a href="#us" style="width:25%" class="w3-bar-item w3-button">Wiwi Sartika & Boy Alexander Marita</a>
...
<!-- About / Wiwi Sartika And Boy Alexander Marita -->
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min" id="us">
  <div class="w3-content">
    <h1 class="w3-center w3-text-black"><b>Wiwi Sartika & Boy Alexander Marita</b></h1>
    <img class="w3-round w3-grayscale-min" src="file:///C:/Users/DELL/Downloads/couple.wedding.jpg" style="width:100%;margin:32px 0">
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="wedding">
  <div class="w3-content">
    ...
    <img class="w3-round-large w3-grayscale-min" src="https://awsimages.detik.net.id/community/media/visual/2021/07/17/gazebo-nikah-ala-kua-di-lamongan-untuk-akad-nikah-2_169.jpeg?w=1200" style="width:100%;margin:64px 0">
    <div class="w3-row">
      <div class="w3-half">
        <h2>When</h2>
      ...
      <div class="w3-half">
        <h2>Where</h2>
        <p>Kantor KUA, Kota Batam, Kepulauan Riau, Indonesia</p>
        <p>Kampung Seraya Bawah, Kota Batam, Kepulauan Riau, Indonesia</p>
      </div>
    </div>
  </div>
</div>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-center w3-wide" id="rsvp">
  ...
  <p class="w3-large">Kindly Respond By Agustus, 2004</p>
  <p class="w3-xlarge">
...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="padding:32px;max-width:600px">
    <div class="w3-container w3-white w3-center">
      ...
      <p><i>Sincerely, Wiwi Sartika & Boy Alexander Marita</i></p>
      <div class="w3-row">
        <div class="w3-half">
